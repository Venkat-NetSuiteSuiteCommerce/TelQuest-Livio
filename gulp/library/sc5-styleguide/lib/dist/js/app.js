...
angular.module('sgApp')
  .controller('SectionsCtrl', ["$scope", "$timeout", "$stateParams", "$location", "$state", "$rootScope", "Styleguide", function($scope, $timeout, $stateParams, $location, $state, $rootScope, Styleguide) {
