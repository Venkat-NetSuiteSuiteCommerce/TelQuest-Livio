...
<div>
    ...
    <p><i class="fas fa-phone"></i> <a href="tel:{{salesRep.phone}}"> : {{salesRep.phone}}</a></p>
    <p><i class="fas fa-envelope-open-text"></i> <a href="mailto:{{salesRep.email}}"> : {{salesRep.email}}</a></p>
