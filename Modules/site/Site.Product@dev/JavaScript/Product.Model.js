	...
	var ProductModel = Backbone.Model.extend(
		{
			...
			validation: {
				'quantity' : {
					fn: function quantityValidator (new_quantity)
					{
						...
						{
						this.setAvailableQtyValue(vendor_quantity)
						}
			...
			//@method setAvailableQtyValue resets the quantity when the users quantity is greater than the vendor quantity in the item
			//@param {number} vendor_quantity
			//@return {Void}
