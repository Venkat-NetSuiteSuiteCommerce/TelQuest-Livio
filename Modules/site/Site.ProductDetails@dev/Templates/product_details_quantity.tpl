	...
	{{#if showQuantity}}
		<div class="product-details-quantity-options" data-validation="control-group">
			...
			<div data-validation="control">
				...
				<input type="number" name="quantity" id="quantity" data-action="changeQuantity" class="product-details-quantity-value" value="{{model.quantity}}" min="1" max="{{vendor_stock}}">
