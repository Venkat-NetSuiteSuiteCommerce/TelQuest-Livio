...
function customizeUI_EstimateBeforeLoad(type, form) {
    try {
        ...
        if (type == 'view' && currentContext.getExecutionContext() == 'userinterface') {
            ...
            if (currentContext.getSetting('SCRIPT', 'custscript_pacejet_' + scripttype + '_show_freightquote') === 'T') {
                ...
                if (currentContext.getSetting('SCRIPT', 'custscript_pacejet_' + scripttype + '_speedintegration') == 'T') {
                    ...
                    buttonScript = "pj_ButtonClick(this,'" + currentContext.getSetting('SCRIPT', 'custscript_pacejet_oc_url_' + scripttype) + "Method=FreightQuoteImport&SubMethod=estimate&TransactionID=" + currentId + "&ExternalTransactionID=" + currentId + "', false, " + (defnamedwindow == 'T' ? 'true' : 'false') + ", '" + Location + "', " + currentId + ", false, '" + license + "')";
                }
        ...
        nlapiLogExecution('DEBUG', 'Estimate Exception', e.message);
    }
}
