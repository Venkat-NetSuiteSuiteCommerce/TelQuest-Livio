...
function customizeUI_PurchaseOrderBeforeLoad(type, form) {
    try {
        ...
        if (type == 'view' && currentContext.getExecutionContext() == 'userinterface') {
            ...
            if (currentContext.getSetting('SCRIPT', 'custscript_pacejet_' + scripttype + '_show_freightquote') === 'T') {
                ...
                if (currentContext.getSetting('SCRIPT', 'custscript_pacejet_' + scripttype + '_speedintegration') == 'T') {
                    ...
                    buttonScript = "pj_ButtonClick(this,'" + currentContext.getSetting('SCRIPT', 'custscript_pacejet_oc_url_' + scripttype) + "Method=FreightQuoteImport&SubMethod=purchaseorder&TransactionID=" + currentId + "&ExternalTransactionID=" + currentId + "', false, " + (defnamedwindow == 'T' ? 'true' : 'false') + ", '" + Location + "', " + currentId + ", false, '" + license + "')";
                }
        ...
        nlapiLogExecution('DEBUG', 'Purchase Order Exception', e.message);
    }
}
