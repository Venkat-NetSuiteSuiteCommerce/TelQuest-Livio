...
describe('ns-uploader 1', function()
{
	...
	it('upload something', function(cb)
	{
		...
		'Some first content'.to('testFolder2/something.txt')
		'Some second content'.to('testFolder2/sub1/hello.txt')
		'Some third content'.to('testFolder2/sub2/world.txt')
		'Some fourth content'.to('testFolder2/sub2/sub22/helloworld.txt')
	...
	{
		'the file was updated and redeployed'.to('testFolder2/sub2/sub22/helloworld.txt')
	...
	// 	'file added after'.to('testFolder2/sub1/newFile.txt');
